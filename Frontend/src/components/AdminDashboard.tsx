    ...
    return (
      <div className="admin-page">
        ...
        <div className="cards-container">
          ...
          <div
            className="card1"
            onClick={() => handleButtonClick("/manageDonations")}
          >
          ...
          <div
            className="card1"
            onClick={() => handleButtonClick("/uploadRequestedProduct")}
          >
          ...
          <div
            className="card1"
            onClick={() => handleButtonClick("/manageRequestedDonations")}
          >
          ...
          <div
            className="card1"
            onClick={() => handleButtonClick("/manageMainPageUsers")}
          >
          ...
          <div
            className="card1"
            onClick={() => handleButtonClick("/newLiveDonation")}
          >
