...
const ManageDonationPage: React.FC = () => {
      ...
      .filter((donation) => {
        ...
        const donorName = donation.donor
          ? donation.donor.firstName?.toLowerCase() +
            " " +
            donation.donor.lastName?.toLowerCase()
          : "";
  ...
  const handleApprovalUpdate = (
    ...
    const updatedDonation = {
      ...donation,
      approvedByAdmin: approvedByAdmin.toString(),
    };
    setDonations((prevDonations) =>
      prevDonations.map((d) => (d._id === donation._id ? updatedDonation : d))
    );
  ...
  if (isAdmin) {
    return (
      <>
        <Box
          className="manage-donations-page"
                  ...
                  <TableRow key={donation._id}>
                    ...
                    <TableCell>
                      <Select
                        ...
                        onChange={(e) =>
                          handleStatusUpdate(donation, e.target.value)
                        }
                        fullWidth
                        variant="outlined"
                      ...
                      >
                        ...
                        <MenuItem style={{ direction: "rtl" }} value="נאסף">
                          נאסף
                        </MenuItem>
                        <MenuItem
                          style={{ direction: "rtl" }}
                    ...
                    <TableCell>
                      ...
                      >
                        ...
                        <MenuItem style={{ direction: "rtl" }} value="false">
                          לא מאושר
                        </MenuItem>
                      </Select>
                    </TableCell>
              ...
              {currentDonation && (
                <div>
                  ...
                  {currentDonation.donorPhone !== '0123456789' &&  currentDonation.donorPhone &&(
                    <Typography variant="body1" sx={{ marginBottom: "10px" }}>
                      {/* console.log(currentDonation.phoneNumber) */}
                      <strong>מספר טלפון:</strong> {currentDonation.donorPhone}
                    </Typography>
                  )}
