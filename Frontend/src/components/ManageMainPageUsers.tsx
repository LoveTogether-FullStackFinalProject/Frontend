    ...
    return (
      <div className="manage-users-page">
        ...
        <Table striped bordered hover responsive className="donors-table">
          ...
          <tbody>
            {sortedAndFilteredDonors
              .filter((donor) => donor.rating === "⭐⭐⭐⭐⭐")
              .map((donor) => (
                <tr key={donor._id}>
                  ...
                  <td>
                    <Dropdown>
                      ...
                      >
                        {donor.isPublished === true || donor.isPublished
                          ? "מאושר"
                          : "לא מאושר"}
                      </Dropdown.Toggle>
                      <Dropdown.Menu>
                        <Dropdown.Item
                          onClick={() => handleApprovalUpdate(donor, true)}
                        >
                          כן
                        </Dropdown.Item>
                        <Dropdown.Item
                          onClick={() => handleApprovalUpdate(donor, false)}
                        >
                          לא
                        </Dropdown.Item>
                      </Dropdown.Menu>
