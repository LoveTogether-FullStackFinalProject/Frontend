            ...
            <div style={{ backgroundColor: "#FFF8DC" }}>
                <div className="d-flex justify-content-center mt-3">
                    <div className="card text-primary bg-white mb-3 w-100 d-flex align-items-center justify-content-center" style={{ minHeight: "10rem" }}>
                        <div className="card-header text-center fw-bold" style={{ fontSize: "3rem", color: "burlywood" }}>ברוכים הבאים!</div>
                        <div className="text-center fw-bold" style={{ fontSize: "2rem", color: "brown" }}>לאתר רישום לכיתות</div>
                    </div>
                </div>
                <div className="vstack gap-3 col-md-7 mx-auto">
                    <h1 className="text-center fw-bold">הרשמה</h1>
                        ...
                        <div className="card-body">
                            <form onSubmit={handleSubmit(registerUser)}>
                                ...
                                <div className="d-flex justify-content-center">
                                    <button type="submit" className="btn btn-success mt-3">הרשמה</button>
                                </div>
                            </form>
                        </div>
                    </div>
